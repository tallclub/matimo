...
function execute(params) {
    return __awaiter(this, void 0, void 0, function () {
        var collectionPath, command, output, collection;
        return __generator(this, function (_a) {
            ...
            try {
                logger.info("Getting collection info: ".concat(collectionPath));
                command = "bru info ".concat(collectionPath);
                ...
                logger.error("Get collection info failed: ".concat(error instanceof Error ? error.message : String(error)));
                return [2 /*return*/, {
                        success: false,
                        collection: {},
