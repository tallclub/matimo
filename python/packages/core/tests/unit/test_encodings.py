...
class TestJsonEncoding:
    def test_dict_values_encoded_to_json_string(self):
    ...
    def test_source_params_removed_after_encoding(self):
...
class TestMimeEncoding:
    def test_mime_base64url_encoded(self):
        params = {
    ...
    def test_mime_source_keys_removed(self):
...
class TestUrlEncoding:
    def test_dict_encoded_as_query_string(self):
...
class TestNoEncoding:
    ...
    def test_params_not_in_source_unchanged(self):
